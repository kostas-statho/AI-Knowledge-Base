...
{
	internal class DynamicWritableColumns : IApiProvider
	{
		public void Build(IApiBuilder builder)
		{
			// This method shows how to dynamically make columns writable

			builder.AddMethod(Method
				.Define("person/masterdatafiltervalues")
				.FromTable("Person")
                .EnableRead()
                .WithWhereClause(
				...
				// The phone number property should be writable only if the IsExternal flag is set
