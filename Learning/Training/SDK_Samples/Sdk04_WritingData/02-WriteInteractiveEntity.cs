...
{
	internal class WriteInteractiveEntity : IApiProvider
	{
		public void Build(IApiBuilder builder)
		{
			// This method shows how to build a writable API method, using an interactive entity.
			// Using interactive entities adds an overhead. Only use interactive entities
			// if you require interactive property evaluation.

			builder.AddMethod(Method
				.Define("person/masterdatainteractive")
				.FromTable("Person")
                .EnableRead()
                .WithWhereClause(
