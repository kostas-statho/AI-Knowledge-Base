-- Purpose  : System role (ESet) ↔ service item (AccProduct) and IT Shop shelf mapping (Module BAS-5)
-- Tables   : ESet, AccProduct, ITShopOrgHasESet, ITShopOrg, AccProductGroup
-- Category : BAS
-- Status   : Verified
-- OIM-Ver  : 9.3
-- Added    : 2026-03-30
-- Notes    : ESet.UID_AccProduct is a direct FK — no junction table exists.
--            ITShopOrgHasESet maps a system role's service item onto an IT Shop shelf.
