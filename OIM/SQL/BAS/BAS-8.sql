-- Purpose  : IT Shop approval chain — find PWO ruler origin and manager chain for a request (Module BAS-8)
-- Tables   : Person, ADSAccount, PersonWantsOrg, HelperHeadPerson
-- Category : BAS
-- Status   : Verified
-- OIM-Ver  : 9.3
-- Added    : 2026-03-30
-- Notes    : QER_FGIPWORulerOrigin() is a built-in OIM function that resolves the
--            effective approval ruler (manager) for a PersonWantsOrg request.
--            @uid_personwantsorg must be replaced before running the parameterised query.
