-- Purpose  : Business role (Org) ↔ service item (AccProduct) via QERAssign, and IT Shop shelf mapping (Module BAS-6)
-- Tables   : QERAssign, Org, AccProduct, ITShopOrgHasQERAssign, ITShopOrg, AccProductGroup
-- Category : BAS
-- Status   : Verified
-- OIM-Ver  : 9.3
-- Added    : 2026-03-30
-- Notes    : QERAssign.ObjectKeyAssignTarget = XObjectKey of the Org (business role).
--            ITShopOrgHasQERAssign maps the assignment resource onto an IT Shop shelf.
