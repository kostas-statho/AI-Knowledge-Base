-- SCRATCH — exploratory ad-hoc queries from SSMS session (2026-03-28)
-- Tables : AccProduct, FirmPartner, Person, PersonWantsOrg
-- Status : Exploratory — hardcoded UIDs, not parameterised
